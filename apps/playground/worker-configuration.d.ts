/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5c28d9c49175050c2df82a346766066)
// Runtime types generated with workerd@1.20260508.1 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		SESSION_SECRET: "dev-only-siwe-session-secret-change-me-in-prod";
		VITE_PIMLICO_URL: string;
		VITE_DEBUG_SEPOLIA_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "SESSION_SECRET" | "VITE_PIMLICO_URL" | "VITE_DEBUG_SEPOLIA_URL">> {}
}
