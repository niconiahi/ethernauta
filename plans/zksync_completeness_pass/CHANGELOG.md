# Plan `zksync_completeness_pass` — CHANGELOG

Source of truth for what landed in each commit of this phase.
Updated as part of the closing protocol's commit step.
...
(`## PR1 — <one-line summary>`). Within a PR, newest commit at
the top. PRs ordered oldest→newest.
