...
export const OUTBOUND_TRANSFER_CUSTOM_REFUND_SIGNATURE = {
  signature:
...
export function outboundTransferCustomRefund(
    ...
    return eth_signTransaction([
      {
        ...
        _ethernauta: {
          function:
            OUTBOUND_TRANSFER_CUSTOM_REFUND_SIGNATURE,
        },
      },
    ])([signer, context])
  }
