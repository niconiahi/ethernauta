...
const SELECTOR = function_selector("withdrawEth", [
  address_codec(),
])
...
describe("start_withdraw_eth", () => {
  it("signs ArbSys.withdrawEth on L2 with msg.value = amount and broadcasts via eth_sendRawTransaction", async () => {
