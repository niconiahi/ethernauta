...
export const SEND_L1_FUNDED_UNSIGNED_TRANSACTION_SIGNATURE =
  {
    signature:
...
export function sendL1FundedUnsignedTransaction(
    ...
    return eth_signTransaction([
      {
        ...
        _ethernauta: {
          function:
            SEND_L1_FUNDED_UNSIGNED_TRANSACTION_SIGNATURE,
        },
      },
    ])([signer, context])
  }
