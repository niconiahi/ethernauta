...
const OUTPUT_CODECS = [uint64(), uint256(), uint256()] as const

export const GAS_ESTIMATE_L1_COMPONENT_SIGNATURE = {
...
export function gasEstimateL1Component(_parameters: Parameters) {
  return (context: ContractContext): Callable<[Uint64, Uint256, Uint256]> => {
    ...
    return {
      ...
      decode: (result: Bytes): [Uint64, Uint256, Uint256] => {
