...
export const MIN_GAS_DYNAMIC_OVERHEAD_DENOMINATOR_SIGNATURE =
  {
    signature: "MIN_GAS_DYNAMIC_OVERHEAD_DENOMINATOR()",
    names: [],
  }

export function MIN_GAS_DYNAMIC_OVERHEAD_DENOMINATOR() {
