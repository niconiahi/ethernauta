...
export const PROOF_SUBMITTERS_SIGNATURE = {
  signature: "proofSubmitters(bytes32,uint256)",
  names: ["arg_0", "arg_1"],
}

const ParametersSchema = union([
  tuple([Bytes32Schema, Uint256Schema]),
  object({ arg_0: Bytes32Schema, arg_1: Uint256Schema }),
])
type Parameters = InferOutput<typeof ParametersSchema>

export function proofSubmitters(_parameters: Parameters) {
