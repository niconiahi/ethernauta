...
---
title: "ERC-2304: Multichain address resolution for ENS"
...
Nick Johnson <<nick@ens.domains>>, "ERC-2304: Multichain address resolution for ENS \[DRAFT]," *Ethereum Improvement Proposals*, no. 2304, September 2019. Available: https\://eips.ethereum.org/EIPS/eip-2304.
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-2304 --objective <objective> | focus on a specific topic |
