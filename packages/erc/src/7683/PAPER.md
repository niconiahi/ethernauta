...
⚠️ Draft [Standards Track: ERC](/erc)

# ERC-7683: Cross Chain Intents

### Programmable solvers for intent protocols.

| Authors | Francisco Giordano ([@frangio](https://github.com/frangio)), Mark Toda ([@marktoda](https://github.com/marktoda)), Matt Rice ([@mrice32](https://github.com/mrice32)), Nick Pai ([@nicholaspai](https://github.com/nicholaspai)), Alexander Lindgren ([@reednaa](https://github.com/reednaa)), Mark Gretzke ([@mgretzke](https://github.com/mgretzke)), Chris Cashwell ([@ccashwell](https://github.com/ccashwell)) |
| --- | --- |
| Created | 2024-04-11 |
| Discussion Link | <https://ethereum-magicians.org/t/erc-cross-chain-intents-standard/19619> |
| Requires | [EIP-7930](/EIPS/eip-7930) |
...
* **Interoperable address**: An address encoded according to [ERC-7930](/EIPS/eip-7930).
...
* `token`: An interoperable address of an [ERC-20](/EIPS/eip-20) token on the chain where the call is made.
...
* `token`: An interoperable address of an [ERC-20](/EIPS/eip-20) token.
...
Francisco Giordano ([@frangio](https://github.com/frangio)), Mark Toda ([@marktoda](https://github.com/marktoda)), Matt Rice ([@mrice32](https://github.com/mrice32)), Nick Pai ([@nicholaspai](https://github.com/nicholaspai)), Alexander Lindgren ([@reednaa](https://github.com/reednaa)), Mark Gretzke ([@mgretzke](https://github.com/mgretzke)), Chris Cashwell ([@ccashwell](https://github.com/ccashwell)), "ERC-7683: Cross Chain Intents \[DRAFT]," *Ethereum Improvement Proposals*, no. 7683, April 2024. Available: https\://eips.ethereum.org/EIPS/eip-7683.
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-7683 --objective <objective> | focus on a specific topic |
