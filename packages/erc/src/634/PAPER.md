---
title: "ERC-634: Storage of text records in ENS"
...
# ERC-634: Storage of text records in ENS

### Profiles for ENS resolvers to store arbitrary text key/value pairs.

| Authors | Richard Moore ([@ricmoo](https://github.com/ricmoo)) |
| --- | --- |
| Created | 2017-05-17 |
| Discussion Link | <https://github.com/ethereum/EIPs/issues/2439> |
| Requires | [EIP-137](/EIPS/eip-137), [EIP-165](/EIPS/eip-165) |
...
Richard Moore ([@ricmoo](https://github.com/ricmoo)), "ERC-634: Storage of text records in ENS \[DRAFT]," *Ethereum Improvement Proposals*, no. 634, May 2017. Available: https\://eips.ethereum.org/EIPS/eip-634.
