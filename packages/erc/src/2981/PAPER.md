...
| Authors | Zach Burks ([@vexycats](https://github.com/vexycats)), James Morgan ([@jamesmorgan](https://github.com/jamesmorgan)), Blaine Malone ([@blmalone](https://github.com/blmalone)), James Seibel ([@seibelj](https://github.com/seibelj)) |
| --- | --- |
| Created | 2020-09-15 |
| Requires | [EIP-165](/EIPS/eip-165) |
...
This standard allows NFTs that support [ERC-721](/EIPS/eip-721) and [ERC-1155](/EIPS/eip-1155) interfaces, to have a standardized way of signalling royalty information. More specifically, these contracts can now calculate a royalty amount to provide to the rightful recipient.
...
Zach Burks ([@vexycats](https://github.com/vexycats)), James Morgan ([@jamesmorgan](https://github.com/jamesmorgan)), Blaine Malone ([@blmalone](https://github.com/blmalone)), James Seibel ([@seibelj](https://github.com/seibelj)), "ERC-2981: NFT Royalty Standard," *Ethereum Improvement Proposals*, no. 2981, September 2020. Available: https\://eips.ethereum.org/EIPS/eip-2981.
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-2981 --objective <objective> | focus on a specific topic |
