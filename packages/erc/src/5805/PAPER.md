...
url: https://eips.ethereum.org/EIPS/eip-5805
...
| Authors | Hadrien Croubois ([@Amxx](https://github.com/Amxx)), Francisco Giordano ([@frangio](https://github.com/frangio)) |
| --- | --- |
| Created | 2022-07-04 |
| Discussion Link | <https://ethereum-magicians.org/t/eip-5805-voting-with-delegation/11407> |
| Requires | [EIP-712](/EIPS/eip-712), [EIP-6372](/EIPS/eip-6372) |
...
#### [ERC-6372](/EIPS/eip-6372): clock and CLOCK\_MODE
...
This signature should follow the [EIP-712](/EIPS/eip-712) format:
...
where `DOMAIN_SEPARATOR` is defined according to [EIP-712](/EIPS/eip-712). The `DOMAIN_SEPARATOR` should be unique to the contract and chain to prevent replay attacks from other domains, and satisfy the requirements of EIP-712, but is otherwise unconstrained.
...
Hadrien Croubois ([@Amxx](https://github.com/Amxx)), Francisco Giordano ([@frangio](https://github.com/frangio)), "ERC-5805: Voting with delegation \[DRAFT]," *Ethereum Improvement Proposals*, no. 5805, July 2022. Available: https\://eips.ethereum.org/EIPS/eip-5805.
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-5805 --objective <objective> | focus on a specific topic |
