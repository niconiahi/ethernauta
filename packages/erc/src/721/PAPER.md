...
| Authors | William Entriken ([@fulldecent](https://github.com/fulldecent)), Dieter Shirley <<dete@axiomzen.co>>, Jacob Evans <<jacob@dekz.net>>, Nastassia Sachs <<nastassia.sachs@protonmail.com>> |
| --- | --- |
| Created | 2018-01-24 |
...
2. [ERC-165](/EIPS/eip-165) Standard Interface Detection.
3. [ERC-173](/EIPS/eip-173) Owned Standard.
...
1. Reddit (announcement of first live discussion). https\://www\.reddit.com/r/ethereum/comments/7r2ena/friday\_119\_live\_discussion\_on\_erc\_nonfungible/
...
William Entriken ([@fulldecent](https://github.com/fulldecent)), Dieter Shirley <<dete@axiomzen.co>>, Jacob Evans <<jacob@dekz.net>>, Nastassia Sachs <<nastassia.sachs@protonmail.com>>, "ERC-721: Non-Fungible Token Standard," *Ethereum Improvement Proposals*, no. 721, January 2018. Available: https\://eips.ethereum.org/EIPS/eip-721.
...
| command                                                                | description               |
|------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-721 --objective <objective> | focus on a specific topic |
