...
export function safeTransferFrom(_parameters: Parameters): Signable<Bytes> {
  return async ([signer, context]: ResolvedSigner): Promise<Bytes> => {
    ...
    const values = Array.isArray(parameters)
      ...
      : ([parameters.from, parameters.to, parameters.id, parameters.value, parameters.data] as const)
