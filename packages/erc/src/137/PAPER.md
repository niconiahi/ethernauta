...
* Appendix B: Sample Resolver Implementations - Built-in resolver - Standalone resolver - Public resolver
...
| command                                                                | description               |
|------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-137 --objective <objective> | focus on a specific topic |
