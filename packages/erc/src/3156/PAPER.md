...
| Authors | Alberto Cuesta Cañada ([@alcueca](https://github.com/alcueca)), Fiona Kobayashi ([@fifikobayashi](https://github.com/fifikobayashi)), fubuloubu ([@fubuloubu](https://github.com/fubuloubu)), Austin Williams ([@onewayfunction](https://github.com/onewayfunction)) |
| --- | --- |
| Created | 2020-11-15 |
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-3156 --objective <objective> | focus on a specific topic |
