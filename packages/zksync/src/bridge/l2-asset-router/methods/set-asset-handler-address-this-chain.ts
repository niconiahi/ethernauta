...
export const SET_ASSET_HANDLER_ADDRESS_THIS_CHAIN_SIGNATURE =
  {
    signature:
...
export function setAssetHandlerAddressThisChain(
    ...
    return eth_signTransaction([
      {
        ...
        _ethernauta: {
          function:
            SET_ASSET_HANDLER_ADDRESS_THIS_CHAIN_SIGNATURE,
        },
      },
    ])([signer, context])
  }
