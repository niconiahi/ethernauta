...
export type BlockNumberOrTag = InferOutput<typeof blockNumberOrTagSchema>

export const blockNumberOrTagOrHashSchema = union([uintSchema, blockTagSchema, hash32Schema])
export type BlockNumberOrTagOrHash = InferOutput<typeof blockNumberOrTagOrHashSchema>
