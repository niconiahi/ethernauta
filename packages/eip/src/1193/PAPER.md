...
| Authors | Fabian Vogelsteller ([@frozeman](https://github.com/frozeman)), Ryan Ghods ([@ryanio](https://github.com/ryanio)), Victor Maia ([@MaiaVictor](https://github.com/MaiaVictor)), Marc Garreau ([@wolovim](https://github.com/wolovim)), Erik Marks ([@rekmarks](https://github.com/rekmarks)) |
| --- | --- |
| Created | 2018-06-30 |
| Requires | [EIP-155](/EIPS/eip-155), [EIP-695](/EIPS/eip-695) |
...
Consult each Ethereum RPC method’s documentation for its `params` and return type. You can find a list of common methods [here](/EIPS/eip-1474).
...
For details, see [EIP-155: Simple replay attack protection](/EIPS/eip-155) and [EIP-695: Create eth\_chainId method for JSON-RPC](/EIPS/eip-695).
...
Fabian Vogelsteller ([@frozeman](https://github.com/frozeman)), Ryan Ghods ([@ryanio](https://github.com/ryanio)), Victor Maia ([@MaiaVictor](https://github.com/MaiaVictor)), Marc Garreau ([@wolovim](https://github.com/wolovim)), Erik Marks ([@rekmarks](https://github.com/rekmarks)), "EIP-1193: Ethereum Provider JavaScript API," *Ethereum Improvement Proposals*, no. 1193, June 2018. Available: https\://eips.ethereum.org/EIPS/eip-1193.
...
| command                                                                 | description               |
|-------------------------------------------------------------------------|---------------------------|
| curl.md https://eips.ethereum.org/EIPS/eip-1193 --objective <objective> | focus on a specific topic |
