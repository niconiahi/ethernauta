...
| Authors | Martin Holst Swende ([@holiman](https://github.com/holiman)), Nick Johnson <<arachnid@notdot.net>> |
| --- | --- |
| Created | 2016-01-20 |
...
| --- | --- | --- |
| `0x00` | [191](/EIPS/eip-191) | Data with intended validator |
| `0x01` | [712](/EIPS/eip-712) | Structured data |
| `0x45` | [191](/EIPS/eip-191) | `personal_sign` messages |
...
The version `0x01` is for structured data as defined in [EIP-712](/EIPS/eip-712)
...
Martin Holst Swende ([@holiman](https://github.com/holiman)), Nick Johnson <<arachnid@notdot.net>>, "ERC-191: Signed Data Standard," *Ethereum Improvement Proposals*, no. 191, January 2016. Available: https\://eips.ethereum.org/EIPS/eip-191.
