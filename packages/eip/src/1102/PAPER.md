...
| Authors | Paul Bouchon <<mail@bitpshr.net>>, Erik Marks ([@rekmarks](https://github.com/rekmarks)) |
| --- | --- |
| Created | 2018-05-04 |
| Discussion Link | <https://ethereum-magicians.org/t/eip-1102-opt-in-provider-access/414> |
| Requires | [EIP-1474](/EIPS/eip-1474) |
...
Paul Bouchon <<mail@bitpshr.net>>, Erik Marks ([@rekmarks](https://github.com/rekmarks)), "EIP-1102: Opt-in account exposure \[DRAFT]," *Ethereum Improvement Proposals*, no. 1102, May 2018. Available: https\://eips.ethereum.org/EIPS/eip-1102.
