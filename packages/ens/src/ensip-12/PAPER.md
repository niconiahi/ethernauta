---
title: "ENSIP-12: Avatar Text Records | ENS Docs"
description: A standard for storage of the avatar text record in ENS.
url: https://docs.ens.domains/ensip/12
site: docs.ens.domains
---

[Skip to content](/ensip/12#vocs-content)
...
This specification standardises a way to store and retrieve this information using [ENSIP-5: Text Records](/ensip/5)
